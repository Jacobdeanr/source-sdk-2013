...
bool CClientShadowMgr::Init()
{
	...
	m_nMaxDepthTextureShadows = 8; //This fix is from https://developer.valvesoftware.com/wiki/Env_projectedtexture/fixes
...
void CClientShadowMgr::InitDepthTextureShadows()
{
	...
	CFastTimer timer;
	timer.Start(); 	// SAUL: set m_nDepthTextureResolution to the depth resolution we want
	m_nDepthTextureResolution = r_flashlightdepthres.GetInt();
